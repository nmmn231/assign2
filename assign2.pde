...
PImage fighter, background, backgroundTwo, hp, treasure, enemy;
PImage startOne, startTwo, endOne, endTwo; 
int treasureX, treasureY, enemyX, enemyY, c, fighterX, fighterY, gamestate, speed=5;
float h;
...
void draw() {
  ...
  switch(gamestate){
    ...
    case GAME_RUN:
      ...
      //background moving
      image(backgroundTwo,c,0);
      image(background,c-640,0);
      image(backgroundTwo,c-1280,0);
      c++;
      c=c%1280;  
